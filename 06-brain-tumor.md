...
- `model_name`: (query param, optional) Model name to use. Default: `Sekenario Satu_model`

Available models:
    - `Sekenario Satu_model`
    - `Sekenario Dua_model`
    - `Sekenario Tiga_model`
    - `Sekenario Empat_model`
    - `Sekenario Lima_model`
