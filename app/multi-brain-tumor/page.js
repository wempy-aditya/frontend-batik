...
const API_URL = "https://batik-otak-ganda.wempyaw.com";
...
export default function BrainTumorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                      ...
                      : samples.map((s, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className={`relative aspect-square rounded-lg overflow-hidden border-2 transition-all active:scale-95 focus:outline-none ${isSelected ? 'border-indigo-500 ring-2 ring-indigo-300' : 'border-transparent hover:border-indigo-400'} ${loadingSample && !isFetching ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                              title={s.name}
                            >
      ...
      <ProjectInfoPanel projectId="019fd059-65fc-7543-89c1-4c829d46bfbf" />
    </div>
  );
}