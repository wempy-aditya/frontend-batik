...
export default function PublicationsPage() {
  ...
  const publications = [
    ...
    },
    {
      ...
      abstract:
        "This survey explores the evolution of neural style transfer from artistic applications to practical use cases in photography, video processing, and augmented reality. We provide a comprehensive taxonomy of existing methods and identify future research directions.",
    ...
    },
    {
      ...
      abstract:
        "We present LiDAR-Net, a lightweight neural network architecture for 3D object detection optimized for mobile robotics. Our approach achieves comparable accuracy to state-of-the-art methods while reducing computational requirements by 75%.",
    ...
    },
    {
      id: 9,
      title:
        "Vision Transformers for Satellite Image Analysis: A Comparative Study",
      abstract:
        "This paper provides a comprehensive comparison of various Vision Transformer architectures for satellite image analysis tasks including land use classification, change detection, and object counting. We evaluate performance across multiple satellite imaging datasets.",
      authors: [
        "Dr. Anna Kowalski",
    ...
    },
    {
      id: 10,
      title:
        "Adversarial Robustness in Deep Learning: Challenges and Solutions",
      abstract:
        "We investigate the vulnerability of deep learning models to adversarial attacks and propose a novel training methodology that improves robustness while maintaining model accuracy. Our approach is evaluated across multiple domains including image classification and natural language processing.",
      authors: [
        "Dr. Thomas Anderson",
        "Dr. Fatima Al-Zahra",
        "Prof. Dimitri Volkov",
    ...
    },
    {
      ...
      abstract:
        "This survey provides a comprehensive overview of graph neural network applications in social media analysis. We cover user behavior prediction, influence analysis, fake news detection, and community detection, highlighting current challenges and future research directions.",
    ...
    },
    {
      ...
      abstract:
        "We explore the application of quantum machine learning algorithms to image recognition tasks. Our hybrid classical-quantum approach shows promising results on small-scale datasets and provides insights into the potential of quantum computing for computer vision.",
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            onClick={() =>
                              (window.location.href = `/publications/${paper.id}`)
                            }
