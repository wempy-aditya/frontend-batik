...
export default function PublicationDetailPage() {
  ...
  const publications = [
    {
      ...
      publisher: "IEEE",
      methodology:
        "We conducted a comprehensive literature review of attention mechanisms published between 2017 and 2024. We implemented and evaluated 15 representative architectures on three benchmark datasets, measuring accuracy, computational complexity, and inference time.",
      results:
        "Our experiments show that hybrid attention mechanisms combining spatial and channel attention achieve the best performance, with an average accuracy improvement of 3.2% over baseline models. However, this comes at a computational cost of 15-20% increased inference time.",
      conclusions:
        "Attention mechanisms significantly enhance the performance of image classification models by enabling them to focus on relevant features. The choice of attention architecture should be guided by the specific requirements of the application, balancing accuracy gains against computational constraints.",
      relatedWork: [
      ...
      figures: [
        {
          id: 1,
          caption: "Overview of attention mechanism architectures",
          type: "diagram",
        },
        {
          id: 2,
      ...
      funding:
        "This research was supported by NSF Grant #1234567 and DARPA Contract #ABC-123.",
      acknowledgments:
    ...
    },
    {
      ...
      publisher: "IEEE/CVF",
      methodology:
        "We implemented our progressive training strategy using PyTorch on a cluster of 8 NVIDIA A100 GPUs. Training was conducted on 1.2M images from multiple datasets. We compared our approach against StyleGAN2, StyleGAN3, and other recent GAN architectures.",
      results:
        "ProGAN-X achieved FID scores of 3.84 on FFHQ, 7.52 on LSUN-Church, demonstrating superior performance. Training time was reduced from 14 days to 8 days for 2048² resolution models. User studies showed 78% preference for our generated images.",
      conclusions:
        "Our progressive training strategy makes high-resolution GAN training more accessible by reducing computational requirements while improving output quality. This opens new possibilities for practical applications in creative industries.",
      relatedWork: [
      ...
      figures: [
        ...
        {
          id: 2,
          caption: "Generated high-resolution samples",
          type: "gallery",
        },
    ...
    },
    {
      ...
      publisher: "IEEE",
      methodology:
        "We trained YOLOv5-AV on a combined dataset of 250K annotated images from KITTI, nuScenes, and our proprietary autonomous driving dataset. Testing was performed on NVIDIA Jetson Xavier NX and Orin platforms.",
      results:
        "YOLOv5-AV achieved 94.2% mAP on KITTI test set, with particularly strong performance on small objects (pedestrians at 50m+). Real-world testing showed 99.1% detection rate for safety-critical objects.",
      conclusions:
        "YOLOv5-AV demonstrates that specialized architectures optimized for specific domains can significantly outperform general-purpose detectors. Our approach provides a practical solution for deployment in production autonomous vehicles.",
      relatedWork: [
      ...
      figures: [
        ...
        {
          id: 2,
          caption: "Detection results in various conditions",
          type: "gallery",
        },
      ...
      funding:
        "This work was supported by autonomous vehicle industry partners and DOT Grant #AV2024-89.",
      acknowledgments:
        "We thank our autonomous vehicle testing partners for data collection support.",
    },
    {
      id: 4,
      title: "Transformer-Based Architecture for Medical Image Segmentation",
      abstract:
        "We propose MedViT, a transformer-based architecture specifically designed for medical image segmentation tasks. Our model achieves state-of-the-art performance on multiple medical imaging benchmarks including brain MRI, cardiac CT, and lung X-ray segmentation.",
      fullAbstract:
      ...
      publisher: "Elsevier",
      methodology:
        "We trained MedViT on five medical imaging datasets totaling 45,000 annotated scans. Pre-training was performed on 1.2M unlabeled medical images. Clinical validation involved 12 radiologists from 3 hospitals.",
      results:
        "MedViT outperformed U-Net, nnU-Net, and TransUNet baselines across all datasets. Average improvement in Dice score was 2.8%. Clinical evaluation showed 92% agreement with expert annotations.",
      conclusions:
        "MedViT demonstrates that domain-specific transformer architectures can significantly advance medical image segmentation. Integration with clinical workflows shows promise for improving diagnostic efficiency and accuracy.",
      relatedWork: [
      ...
      figures: [
        ...
        {
          id: 2,
          caption: "Segmentation results across modalities",
          type: "gallery",
        },
        {
          id: 3,
      ...
      acknowledgments:
        "We thank participating hospitals and radiologists for clinical validation.",
    },
    {
      id: 5,
      title: "Federated Learning for Privacy-Preserving Computer Vision",
      abstract:
        "This work presents a novel federated learning framework for training computer vision models across distributed datasets while preserving privacy. We demonstrate significant improvements in model accuracy while reducing communication overhead by 60%.",
      fullAbstract:
      ...
      methodology:
        "We simulated federated learning scenarios with 100-1000 clients using realistic non-IID data partitions. Communication costs and privacy were measured using formal differential privacy analysis. Real-world validation used 500 mobile devices.",
      results:
        "FedVision achieved 97.2% of centralized accuracy on ImageNet-100 with 60% reduction in communication overhead. Privacy guarantees of ε=3.0 differential privacy were maintained throughout training.",
      conclusions:
        "FedVision demonstrates that federated learning can provide practical privacy-preserving solutions for computer vision without significant accuracy degradation. This enables new applications in healthcare, finance, and other privacy-sensitive domains.",
      relatedWork: [
      ...
      acknowledgments:
        "We thank edge device manufacturers for deployment support.",
    },
    {
      id: 6,
      title:
        "Self-Supervised Learning for Visual Representation: A Comprehensive Study",
      abstract:
        "We conduct a comprehensive empirical study of self-supervised learning methods for visual representation learning. Our analysis covers over 15 different approaches and evaluates their performance across multiple downstream tasks.",
      fullAbstract:
      ...
      publisher: "Springer",
      methodology:
        "We implemented 15 self-supervised methods using identical training protocols. Pre-training used ImageNet-1K (1.2M images). Evaluation covered 8 downstream tasks across 12 datasets. All experiments used ViT-Base architecture for fair comparison.",
      results:
        "Masked image modeling (MAE) achieved best performance on dense prediction tasks (83.2% mIoU on ADE20K). Contrastive methods (MoCo v3) excelled at classification (84.1% on ImageNet). Hybrid approaches showed promising results across multiple tasks.",
      conclusions:
        "This comprehensive study provides evidence-based guidelines for selecting self-supervised learning methods. The choice should be guided by downstream task requirements, with masked image modeling preferred for dense prediction and contrastive learning for classification tasks.",
      relatedWork: [
      ...
      figures: [
        {
          id: 1,
          caption: "Taxonomy of self-supervised methods",
          type: "diagram",
        },
        {
          id: 2,
          caption: "Performance across downstream tasks",
          type: "chart",
        },
      ...
      acknowledgments:
        "We acknowledge computational resources provided by partner institutions.",
    },
  ];
  ...
  const citationFormats = {
    bibtex: `@article{${publication.authors[0].split(" ").pop().toLowerCase()}${
      publication.year
    }${publication.title.split(" ")[0].toLowerCase()},
  ...
  doi={${publication.doi}}
    ...
    apa: `${publication.authors.join(", ")} (${publication.year}). ${
      publication.title
    }. ${publication.venue}. https://doi.org/${publication.doi}`,
    mla: `${publication.authors.join(", ")}. "${publication.title}." ${
      publication.venue
    }, ${publication.year}. doi:${publication.doi}`,
    chicago: `${publication.authors.join(", ")}. "${publication.title}." ${
      publication.venue
    } (${publication.year}). https://doi.org/${publication.doi}`,
  };
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="lg:w-3/4">
                <div className="flex flex-wrap gap-3 mb-6">
                  ...
                  <span
                    className={`px-4 py-2 text-sm font-medium rounded-full ${getImpactColor(
                      publication.impact
                    )}`}
                  >
              ...
              <div className="sticky top-8 space-y-6">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-6">
                  ...
                  <div className="space-y-3">
                    <button
                      onClick={() =>
                        (window.location.href = `/publications/${publication.id}/pdf`)
                      }
