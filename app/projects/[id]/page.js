  ...
  const projects = [
    {
      ...
      gallery: [
        { type: "image", gradient: "from-amber-400 to-orange-400" },
        { type: "image", gradient: "from-orange-400 to-red-400" },
    ...
    },
    {
      ...
      description: "Generate high-quality images from text descriptions using diffusion models and transformer architectures. Create art, illustrations, and concept designs from prompts.",
      fullDescription: "Text-to-Image Generator leverages cutting-edge diffusion models and transformer architectures to create stunning, high-quality images from natural language descriptions. Built on Stable Diffusion and CLIP technologies, the system understands complex prompts and generates coherent, aesthetically pleasing images that match the description. Users can create anything from photorealistic scenes to artistic illustrations, concept designs, and abstract art simply by describing what they want to see.",
    ...
    },
    {
      ...
      description: "Reconstruct 3D objects from 2D images using photogrammetry and neural networks. Create detailed 3D models for gaming, AR/VR, and design.",
      fullDescription: "3D Object Reconstruction project combines traditional photogrammetry techniques with modern neural networks, particularly Neural Radiance Fields (NeRF), to create highly detailed 3D models from sets of 2D images. The system can reconstruct objects, scenes, and even entire environments with photorealistic textures and accurate geometry. Applications range from gaming asset creation to AR/VR experiences, architectural visualization, and digital preservation of cultural artifacts.",
      technologies: ["3D Reconstruction", "Photogrammetry", "Neural Radiance Fields", "Blender"],
    ...
    },
    {
      ...
      description: "Generate images from voice descriptions using multimodal AI. Convert speech to visual content with emotion and tone awareness for creative applications.",
      fullDescription: "Voice-to-Image Synthesis represents the next frontier in multimodal AI, allowing users to create images simply by speaking their ideas. The system combines advanced speech recognition with emotion and tone analysis, then uses this rich understanding to generate images that not only match the description but also capture the emotional intent and style suggested by the speaker's voice. This technology opens new possibilities for hands-free creative expression and accessibility.",
      technologies: ["Speech Recognition", "Multimodal AI", "Voice Processing", "Image Synthesis"],
    ...
    },
    {
      ...
      description: "Analyze aerial and drone footage for environmental monitoring, agriculture, and urban planning using computer vision and geospatial AI technologies.",
      fullDescription: "Drone Image Analysis system processes aerial imagery from drones and satellites to provide actionable insights for environmental monitoring, precision agriculture, urban planning, and disaster response. Using advanced computer vision and geospatial AI, the system can detect changes over time, classify land use, monitor crop health, identify infrastructure issues, and track environmental indicators. The platform processes large-scale imagery efficiently and provides interactive visualization tools for data exploration.",
      technologies: ["Drone AI", "Geospatial Analysis", "Environmental AI", "Satellite Imagery"],
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="lg:w-1/3">
                <div className={`relative h-64 rounded-3xl overflow-hidden bg-gradient-to-br ${project.thumbnail} shadow-2xl`}>
                  <div className="absolute inset-0 bg-black/20"></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-white text-6xl font-bold opacity-50">#{project.id}</div>
                  </div>
                  {/* Floating Particles */}
              ...
              <div className="lg:w-2/3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-white">{project.team} members</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-white">{project.startDate}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-6xl">
          ...
          <div className="mb-12">
            <div className="flex flex-wrap gap-4 border-b-2 border-gray-200">
              {['overview', 'technologies', 'challenges', 'achievements', 'gallery'].map((tab) => (
                <button
                  key={tab}
                  ...
                  {project.technologies.map((tech, index) => (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${project.thumbnail} flex items-center justify-center flex-shrink-0`}>
            ...
            {activeTab === 'challenges' && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    Every groundbreaking project faces unique challenges. Here's how we addressed them.
                  </p>
                </div>
            ...
            {activeTab === 'achievements' && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    Milestones and accomplishments that define the success of this project.
                  </p>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {project.gallery.map((item, index) => (
                    ...
                    >
                      <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient} transition-all duration-500 group-hover:scale-110`}>
                        <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-all duration-500"></div>
                      </div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <div className="bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full">
                          <span className="text-gray-900 font-semibold">View Image {index + 1}</span>
                        </div>
                      </div>
                    </div>
                  ))}
