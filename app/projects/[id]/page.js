          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="lg:w-1/3">
                <div
                  className={`relative h-64 rounded-3xl overflow-hidden bg-gradient-to-br ${project.thumbnail} shadow-2xl`}
                >
                  ...
                  {project.technologies.map((tech, index) => (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${project.thumbnail} flex items-center justify-center flex-shrink-0`}
                        >
