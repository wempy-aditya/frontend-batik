        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-8">
              ...
              <span className="text-sm font-semibold text-amber-200">Complete Project Portfolio</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
              Explore our comprehensive collection of AI and computer vision projects. From research prototypes 
              to production-ready solutions, discover innovation at every level.
            </p>
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-200/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 h-full">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${project.thumbnail} rounded-3xl opacity-0 group-hover:opacity-5 transition-opacity duration-500`}></div>
                  
                  {/* Animated Border Glow */}
                  <div className={`absolute inset-0 bg-gradient-to-r ${project.thumbnail} rounded-3xl opacity-0 group-hover:opacity-20 blur-sm transition-all duration-500 scale-105`}></div>
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className={`px-3 py-1 text-xs font-medium rounded-full ${getComplexityColor(project.complexity)}`}>
                        {project.complexity}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 p-6 space-y-4">
                    ...
                    <div 
                      onClick={() => {
                        console.log(`Navigating to project ${project.id} details`);
          ...
          <div className="text-center mt-20">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Join our team of researchers and developers working on cutting-edge AI projects.
              </p>
