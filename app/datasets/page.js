...
export default function DatasetsPage() {
  ...
  const datasets = [
    {
      id: 1,
      name: "ImageNet-2024",
      description: "Large-scale dataset with over 14 million images across 20,000+ categories for object recognition research and deep learning training.",
      size: "150GB",
      samples: "14.2M",
      categories: "20K+",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "Comprehensive medical imaging collection including X-rays, MRIs, and CT scans with expert annotations for diagnostic AI.",
      size: "200GB",
      samples: "500K",
      categories: "25",
      accessType: "Registered",
    ...
    },
    {
      ...
      description: "Urban scene understanding dataset with pixel-level annotations for autonomous driving and smart city applications.",
      size: "80GB",
      samples: "150K",
      categories: "30",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "High-resolution fashion product dataset with detailed attribute annotations for e-commerce and style recommendation systems.",
      size: "35GB",
      samples: "250K",
      categories: "100",
      accessType: "Premium",
    ...
    },
    {
      ...
      description: "Global satellite imagery dataset for environmental monitoring, agriculture analysis, and climate change research.",
      size: "500GB",
      samples: "2.5M",
      categories: "15",
      accessType: "Registered",
    ...
    },
    {
      ...
      description: "Multi-view 3D object dataset with depth information and pose annotations for robotics and AR/VR applications.",
      size: "120GB",
      samples: "180K",
      categories: "200",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "Digitized historic artwork spanning centuries with detailed metadata for art history research and style analysis.",
      size: "25GB",
      samples: "120K",
      categories: "40",
      accessType: "Premium",
    ...
    },
    {
      ...
      description: "Diverse facial recognition dataset with privacy-compliant annotations for identity verification and emotion analysis.",
      size: "60GB",
      samples: "500K",
      categories: "1000",
      accessType: "Registered",
    ...
    },
    {
      ...
      description: "Manufacturing defect dataset for quality control and automated inspection systems in industrial environments.",
      size: "40GB",
      samples: "300K",
      categories: "50",
      accessType: "Premium",
    ...
    },
    {
      ...
      description: "Document analysis dataset with OCR annotations for text extraction and document understanding applications.",
      size: "15GB",
      samples: "75K",
      categories: "20",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "Advanced semantic segmentation dataset with fine-grained pixel annotations for computer vision research.",
      size: "90GB",
      samples: "200K",
      categories: "80",
      accessType: "Registered",
    ...
    },
    {
      ...
      description: "Contemporary art dataset featuring modern artistic movements and styles for AI art generation and analysis.",
      size: "18GB",
      samples: "95K",
      categories: "35",
      accessType: "Premium",
    ...
    },
    {
      ...
      description: "Global traffic sign dataset for autonomous vehicle development and traffic management systems.",
      size: "30GB",
      samples: "180K",
      categories: "100",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "Comprehensive scene understanding dataset combining instance and semantic segmentation for holistic AI vision.",
      size: "110GB",
      samples: "220K",
      categories: "120",
      accessType: "Registered",
    ...
    },
    {
      ...
      description: "Abstract art dataset for generative AI models and creative applications in digital art creation.",
      size: "20GB",
      samples: "110K",
      categories: "25",
      accessType: "Public",
    ...
    },
    {
      ...
      description: "Aerial surveillance dataset for security applications and crowd monitoring with privacy-preserving annotations.",
      size: "75GB",
      samples: "160K",
      categories: "40",
      accessType: "Premium",
  ...
  const filteredDatasets = datasets.filter(dataset => {
    ...
    const accessMatch = selectedAccess === 'all' || dataset.accessType === selectedAccess;
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-8">
              ...
              <span className="text-sm font-semibold text-gray-200">Complete Dataset Library</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
              Explore our comprehensive collection of curated datasets for machine learning research. 
              From computer vision to NLP, find the perfect data for your next breakthrough.
            </p>
            ...
            <div className="grid grid-cols-4 gap-6 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-white">1TB+</div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="mb-12 space-y-6">
            ...
            {/* Access Type Filter */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Filter by Access</h3>
              <div className="flex flex-wrap gap-3">
                {accessTypes.map((access) => (
                  ...
                  >
                    {access.name}
                    <span className="ml-2 text-sm opacity-75">({access.count})</span>
                  </button>
                ))}
              </div>
            </div>
                ...
                <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 h-full">
                  ...
                  <div className="relative h-40 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className={`px-3 py-1 text-xs font-semibold rounded-full border ${getAccessColor(dataset.accessType)}`}>
                        {dataset.accessType}
                      </span>
                    </div>
