        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
              ...
              <span className="text-sm font-semibold text-amber-200">Get In Touch</span>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="research" className="bg-stone-900">Research Collaboration</option>
                    <option value="enterprise" className="bg-stone-900">Enterprise Solutions</option>
                    <option value="support" className="bg-stone-900">Technical Support</option>
                    <option value="partnership" className="bg-stone-900">Partnership</option>
