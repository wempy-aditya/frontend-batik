  ...
  const teamMembers = [
    {
      ...
      description: "PhD in Computer Vision with 10+ years experience in deep learning",
      social: {
        linkedin: "#",
        twitter: "#",
        github: "#"
    ...
    },
    {
      ...
      description: "Specialized in generative models and image processing pipelines",
      social: {
        linkedin: "#",
        twitter: "#",
        github: "#"
  ...
  const values = [
    {
      ...
      title: "Innovation",
      description: "Pushing the boundaries of what's possible with AI and computer vision technology"
    },
    {
    ...
    },
    {
      ...
      title: "Quality",
      description: "Maintaining highest standards in research, development, and deployment"
    },
    {
      icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
      title: "Open Science",
      description: "Contributing to the global AI community through open-source projects"
    }
  ];

  const milestones = [
    { year: "2020", event: "Founded with a vision to democratize AI image processing" },
    { year: "2021", event: "Released first open-source dataset with 50K+ annotated images" },
    { year: "2022", event: "Reached 100K+ active users and 500+ research citations" },
    { year: "2023", event: "Launched advanced generative models and processing pipeline" },
    { year: "2024", event: "Partnered with 50+ universities and research institutions" },
    { year: "2025", event: "Expanded to 1M+ users with enterprise-grade solutions" }
  ];
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
              ...
              <span className="text-sm font-semibold text-amber-200">Our Story</span>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We're building the future of AI-powered image processing and computer vision, 
              making advanced technology accessible to researchers and developers worldwide.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                We believe that advanced AI technology should be accessible to everyone. 
                Our mission is to democratize computer vision and image processing by 
                providing cutting-edge tools, comprehensive datasets, and educational 
                resources to researchers, developers, and organizations worldwide.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
                Through continuous innovation and collaboration with the global AI community, 
                we're pushing the boundaries of what's possible with artificial intelligence, 
                making it easier for everyone to build intelligent visual systems.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <a href={member.social.linkedin} className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center hover:bg-amber-500 transition-colors duration-300">
                        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                        </svg>
                      </a>
                      <a href={member.social.twitter} className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center hover:bg-amber-500 transition-colors duration-300">
                        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"/>
                        </svg>
                      </a>
                      <a href={member.social.github} className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center hover:bg-amber-500 transition-colors duration-300">
                        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl p-12 text-center">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Be part of the AI revolution. Whether you're a researcher, developer, or enthusiast, 
