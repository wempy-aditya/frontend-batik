...
export default function GalleryPage() {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      model: "Midjourney",
      prompt: "Serene mountain landscape with aurora borealis dancing in the sky",
      likes: 2156,
      views: 8920,
      downloads: 540
    },
    {
      ...
      prompt: "Abstract geometric patterns with flowing motion and vibrant colors",
      likes: 890,
      views: 3240,
      downloads: 210
    },
    ...
    },
    {
      ...
      model: "Midjourney",
      prompt: "Ethereal portrait with flowing light effects and dreamy atmosphere",
      likes: 3240,
      views: 12500,
      downloads: 890
    },
    ...
    },
    {
      ...
      model: "DALL-E 3",
      prompt: "Enchanted forest with bioluminescent creatures and magical atmosphere",
      likes: 2890,
      views: 10340,
      downloads: 670
    },
    ...
    },
    {
      ...
      model: "Stable Diffusion",
      prompt: "Futuristic metropolis with holographic displays and flying vehicles",
      likes: 2670,
      views: 11230,
      downloads: 720
    },
    {
      ...
      gradient: "from-amber-500 via-orange-500 to-red-500",
      model: "DALL-E 3",
      prompt: "Flowing abstract waves with gradient colors and smooth transitions",
      likes: 1230,
      views: 4890,
      downloads: 340
    },
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" onClick={closeModal}>
          <div className="relative max-w-6xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid md:grid-cols-2 gap-6 bg-stone-900 rounded-2xl overflow-hidden">
              {/* Image */}
              <div className={`relative h-96 md:h-[600px] bg-gradient-to-br ${selectedImage.gradient}`}>
                <div className="absolute inset-0 opacity-20">
                  <div className="w-full h-full"
                       style={{
                         backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Cpath d='m30 60l30-30h-60l30 30z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
