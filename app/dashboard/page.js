            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-semibold text-gray-900">Manage Publications</p>
              ...
              <button 
                ...
                className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border-2 border-purple-200 hover:border-purple-300 transition-colors group"
              >
                <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">New dataset uploaded</p>
                  <p className="text-sm text-gray-600">Research Data #12 was added to the system</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">Publication updated</p>
                  <p className="text-sm text-gray-600">"Batik Pattern Analysis" has been published</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">New project started</p>
                  <p className="text-sm text-gray-600">AI-Driven Pattern Recognition project initialized</p>
                </div>
