                    ...
                    {samplesLoading
                      ...
                      : samples.map((s, idx) => (
                          <button
                            ...
                            className="aspect-square rounded-lg overflow-hidden border-2 border-transparent hover:border-sky-400 transition-all hover:scale-105 focus:outline-none focus:border-sky-500"
                            title={s.name}
                          >
                            <img
                              src={s.url}
