  ...
  const fallbackDatasets = [
    {
      ...
      name: "ImageNet-2024",
      description:
        "Large-scale dataset with over 14 million images across 20,000+ categories for object recognition research.",
      size: "150GB",
      samples: "14.2M",
      categories: "20K+",
      accessType: "Public",
          ...
          {loading ? (
            ...
            displayDatasets.map((dataset) => (
              ...
              >
                {/* Dataset Card */}
                <div
                  className={`relative bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-100 transition-all duration-500 transform hover:-translate-y-1 ${
                ...
                >
                  ...
                  <div className="relative h-40 overflow-hidden">
                    ...
                    {dataset.sample_image_url ? (
                      <>
                        ...
                        />
                        <div
                          className={`hidden absolute inset-0 bg-gradient-to-br ${
                    ...
                    <div className="absolute top-4 right-4 z-10">
                      <span
                        className={`px-3 py-1 text-xs font-semibold rounded-full ${
                          dataset.accessColor || "bg-green-100 text-green-800"
                        } shadow-md`}
                      >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4 z-10">
                      <div className="flex justify-between text-white text-sm font-medium">
                        ...
                        <span>
                          {dataset.size
                            ? `${(dataset.size / (1024 * 1024 * 1024)).toFixed(
                                1
                              )}GB`
                            : "N/A"}
                        </span>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 line-clamp-[7]">
                      {dataset.description}
                    </p>
                    ...
                    <div className="space-y-2">
                      <button
                        onClick={() =>
                          router.push(`/datasets/${dataset.slug || dataset.id}`)
                        }
